...
public class Client {
    ...
    public ResponseEntity<List<StatOutDto>> get(
            @NotBlank String start, @NotBlank String end, @Nullable String[] uris, boolean unique) {
        ...
        try {
            return rest.exchange("/stats", HttpMethod.GET, requestEntity, getRef, parameters);
